	...
	<div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
		...
		<div class="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
			<button type="button" data-dropdown-toggle="language-dropdown-menu"
				class="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-white dark:text-white rounded-lg cursor-pointer hover:bg-black dark:hover:bg-whitee">
		...
		<div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1"
			...
			<ul
				...
				<li>
					<a href="index-eua.php" class="block py-2 px-3 text-white rounded md:bg-transparent md:p-0"
						aria-current="page">Home</a>
				</li>
				<li>
					<a href="index-eua.php#tech"
						class="block py-2 px-3 text-white rounded md:bg-transparent md:p-0">Technology</a>
				</li>
				<li>
					<a href="index-eua.php#compe"
        ...
        <div class="job flex flex-row justify-center align-center">
            ...
            <div class="list flex flex-col">
                <h1
                    ...
                    <span class="text-transparent bg-clip-text title-degradado" id="top">MY PROJECTS</span>
                </h1>
